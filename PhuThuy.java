...
public class PhuThuy extends NhanVat {
	...
	public PhuThuy(double mana, double blood, double satThuong, String ten, int iD, String gioiTinh, int namSinh,
	...
	public String toString() {
		return "PhuThuy [kiem=" + kiem + ", cungTen=" + cungTen + ", duaPhep=" + duaPhep + ", phao=" + phao
